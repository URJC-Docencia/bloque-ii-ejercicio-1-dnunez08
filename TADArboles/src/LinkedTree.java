...
public class LinkedTree<E> implements NAryTree<E> {
    ...
    private class TreeNode<T> implements Position<T> {
        ...
        public TreeNode(T eleTent) {
            this.eleTent = eleTent;
        }
        ...
        public void setEleTent(T eleTent) {
            this.eleTent = eleTent;
        }
    ...
    public void swapElements(Position<E> p1, Position<E> p2) {
        ...
        node1.eleTent = node2.getElement();
        node2.eleTent = aux;
    }
    ...
    @Override
    public void remove(Position<E> p1, Position<E> p2 ) {
       TreeNode<E> node = checkPosition(p1);
       if(node==root){
        root= null;
        size=0;
       }else{
    ...
    private void breadthOrder(LinkedTree<E>.TreeNode<E> node, List<Position<E>> positions) {
        if( node != null){
